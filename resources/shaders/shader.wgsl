struct VertexInput {
	...
	@location(2) worldColor: vec3f,
	@location(3) objectColor: vec3f,
	@location(4) uv: vec2f,
...
struct VertexOutput {
	...
	@location(0) worldColor: vec3f,
	@location(1) objectColor: vec3f,
...
fn vs_main(in: VertexInput) -> VertexOutput {
    ...
    out.worldColor = in.worldColor;
    out.objectColor = in.objectColor;
    out.uv = in.uv;
...
fn fs_main(in: VertexOutput) -> @location(0) vec4f {
    ...
    return vec4f(linear_color, uSharedUniforms.objectColor.a);
}